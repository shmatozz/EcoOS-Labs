...
typedef struct IEcoLab1VTblEvents {
    ...
    /* IEcoLab1Events */
	int16_t (ECOCALLMETHOD *OnOutputStringCallback)(/* in */ struct IEcoLab1Events* me, 
												    /* in */ char* str);

    int16_t (ECOCALLMETHOD *OnMaxFindCallback)(/* in */ struct IEcoLab1Events* me, 
											   /* in */ int max);

	int16_t (ECOCALLMETHOD *OnCountingReadyCallback)(/* in */ struct IEcoLab1Events* me, 
													 /* in */ int max, 
													 /* in */ int* count_buffer);

	int16_t (ECOCALLMETHOD *OnElementPlacedCallback)(/* in */ struct IEcoLab1Events* me, 
													 /* in */ int element, size_t index);
