...
#include "CEcoLab1StableFactory.h"
 ...
 *
 */
int16_t ECOCALLMETHOD CEcoLab1StableFactory_QueryInterface(IEcoComponentFactory* me, const UGUID* riid, void** ppv) {
 ...
 *
 */
uint32_t ECOCALLMETHOD CEcoLab1StableFactory_AddRef(/* in */ IEcoComponentFactory* me) {
    CEcoLab1StableFactory* pCMe = (CEcoLab1StableFactory*)me;
 ...
 *
 */
uint32_t ECOCALLMETHOD CEcoLab1StableFactory_Release(/* in */ IEcoComponentFactory* me) {
    CEcoLab1StableFactory* pCMe = (CEcoLab1StableFactory*)me;
 ...
 *
 */
int16_t ECOCALLMETHOD CEcoLab1StableFactory_Init(/* in */ struct IEcoComponentFactory* me, /* in */ struct IEcoUnknown *pIUnkSystem, /* in */ void* pv) {
    CEcoLab1StableFactory* pCMe = (CEcoLab1StableFactory*)me;
    int16_t result = -1;
 ...
 *
 */
int16_t ECOCALLMETHOD CEcoLab1StableFactory_Alloc(/* in */ struct IEcoComponentFactory* me, /* in */ struct IEcoUnknown *pISystem, /* in */ struct IEcoUnknown *pIUnknownOuter, /* in */ const UGUID* riid, /* out */ void** ppv) {
    CEcoLab1StableFactory* pCMe = (CEcoLab1StableFactory*)me;
    IEcoUnknown* pIUnk = 0;
    int16_t result = -1;
 ...
 *
 */
char_t* ECOCALLMETHOD CEcoLab1StableFactory_get_Name(/* in */ struct IEcoComponentFactory* me) {
    CEcoLab1StableFactory* pCMe = (CEcoLab1StableFactory*)me;
 ...
 *
 */
char_t* ECOCALLMETHOD CEcoLab1StableFactory_get_Version(/* in */ struct IEcoComponentFactory* me) {
    CEcoLab1StableFactory* pCMe = (CEcoLab1StableFactory*)me;
 ...
 *
 */
char_t* ECOCALLMETHOD CEcoLab1StableFactory_get_Manufacturer(/* in */ struct IEcoComponentFactory* me) {
    CEcoLab1StableFactory* pCMe = (CEcoLab1StableFactory*)me;
...
IEcoComponentFactoryVTbl g_x1F5DF16EE1BF43B999A434ED38FE8F3BFactoryVTbl = {
        CEcoLab1StableFactory_QueryInterface,
        CEcoLab1StableFactory_AddRef,
        CEcoLab1StableFactory_Release,
        CEcoLab1StableFactory_Alloc,
        CEcoLab1StableFactory_Init,
        CEcoLab1StableFactory_get_Name,
        CEcoLab1StableFactory_get_Version,
        CEcoLab1StableFactory_get_Manufacturer
};
 ...
 *
 */
CEcoLab1StableFactory g_x1F5DF16EE1BF43B999A434ED38FE8F3BFactory = {
        &g_x1F5DF16EE1BF43B999A434ED38FE8F3BFactoryVTbl,
        0,
        (CreateInstance)createCEcoLab1Stable,
        (InitInstance)initCEcoLab1Stable,
        "EcoLab1Stable\0",
        "1.0.0.0\0",
        "Baryshev_Matvey_Ilich\0"
};
