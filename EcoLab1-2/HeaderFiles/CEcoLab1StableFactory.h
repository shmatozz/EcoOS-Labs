...
#ifndef __C_ECOLAB1STABLE_FACTORY_H__
#define __C_ECOLAB1STABLE_FACTORY_H__

#include "IEcoSystem1.h"

typedef struct CEcoLab1StableFactory {
...
} CEcoLab1StableFactory;

#endif /* __C_ECOLAB1STABLE_FACTORY_H__ */
